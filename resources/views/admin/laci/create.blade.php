    ...
    <div class="page-card">
        ...
        <div class="card-body">
            ...
            <div class="lab-info-box">
                🏫 <div>
                    <span style="font-size:12px; opacity:0.8;">Laci ini akan otomatis masuk ke lab:</span><br>
            ...
            <form action="{{ route('admin.laci.store') }}" method="POST">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('kode_laci') }}"
                               placeholder="Contoh: LCI-01"
                               required>
                        @error('kode_laci')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        <span class="hint">Kode unik untuk identifikasi laci</span>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nama_laci') }}"
                               placeholder="Contoh: Laci Elektronik A"
                               required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                              ...
                              placeholder="Deskripsi isi atau fungsi laci ini...">{{ old('deskripsi') }}</textarea>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-save">💾 Simpan Laci</button>
                </div>
            </form>
        </div>
    </div>

    ...
    <nav class="top-navbar">
        <div class="top-navbar-container">
            ...
            <ul class="nav-menu" id="navMenu">
                <li><a href="{{ route('super-admin.dashboard') }}" class="{{ request()->routeIs('super-admin.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-home"></i> Dashboard
                </a></li>
                <li><a href="{{ route('super-admin.admins.index') }}" class="{{ request()->routeIs('super-admin.admins.*') ? 'active' : '' }}">
                    <i class="fas fa-user-shield"></i> Kelola Admin
                </a></li>
                <li><a href="{{ route('super-admin.riwayat-peminjaman') }}" class="{{ request()->routeIs('super-admin.riwayat-peminjaman') ? 'active' : '' }}">

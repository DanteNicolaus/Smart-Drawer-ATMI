    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="{{ route('user.katalog') }}" class="{{ request()->routeIs('user.katalog') || request()->routeIs('user.alat.*') ? 'active' : '' }}">
                    📦 Katalog Alat
                </a></li>
                <li><a href="{{ route('user.riwayat') }}" class="{{ request()->routeIs('user.riwayat') || request()->routeIs('user.peminjaman.*') ? 'active' : '' }}">
                    📜 Riwayat
                </a></li>
                <li><a href="{{ route('user.settings') }}" class="{{ request()->routeIs('user.settings') ? 'active' : '' }}">
                    ⚙️ Pengaturan
                </a></li>
            </ul>

            <!-- Right side: Avatar + Logout + Burger -->
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <div class="user-role">{{ auth()->user()->nim }}</div>
                </div>

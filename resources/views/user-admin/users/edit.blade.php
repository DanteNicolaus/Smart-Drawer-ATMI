...
<div class="container-fluid px-4">
    ...
    <div class="page-header mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Edit data user: <strong>{{ $user->name }}</strong></p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="form-card">
                <div class="form-header edit">
                    <h6>
                        <i class="fas fa-edit"></i> Form Edit Data User
                    </h6>
                </div>
                <div class="form-body">
                    <form action="{{ route('user-admin.users.update', $user) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="koin">
                                Jumlah Koin <span class="required">*</span>
                            </label>
                            <input 
                                type="number" 
                                class="form-input @error('koin') error @enderror" 
                                id="koin" 
                                name="koin" 
                                value="{{ old('koin', $user->koin) }}" 
                                min="0"
                                required
                            >
                            @error('koin')
                            ...
                            <small class="form-hint">
                                ...
                                Koin saat ini: <strong>{{ $user->koin }}</strong>
                            </small>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="user-info-card">
                ...
                <div class="user-info-body">
                    <div class="info-row">
                        ...
                        <code class="info-value">{{ $user->nim }}</code>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Email:</span>
                        <span class="info-value-small">{{ $user->email }}</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        <span class="info-label">Koin:</span>
                        <span class="badge badge-warning"><i class="fas fa-coins"></i> {{ $user->koin }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Terdaftar:</span>
                        <span class="info-value-small">{{ $user->created_at->format('d M Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card blue">
                <div class="info-header">
                    <i class="fas fa-info-circle"></i>
                    <h6>Ketentuan Edit</h6>
                </div>
                <div class="info-body">
                    <ul class="info-list">
                        <li>NIM dan email harus tetap unik</li>
                        <li>Password hanya diubah jika diisi</li>
                        <li>Koin dapat disesuaikan manual</li>
            ...
            <div class="warning-card">
                ...
                <h6>Perhatian!</h6>
                <p>
                    Perubahan data akan langsung berpengaruh pada sistem. 
...
<style>
    ...
    .alert-error-list .alert-icon, .alert-error .alert-icon {
        font-size: 24px;
    }
